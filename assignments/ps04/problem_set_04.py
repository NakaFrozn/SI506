...
for i in range(1, len(employers)):
    name = employers[i][0].strip().lower()
    if name.find("university") > -1 and name.find("innovation") > -1:
        universities_innovation.append(employers[i])
    else:
...
for company in other_companies:
    industry = company[-1].lower().strip()
    if industry == "consulting":
        consulting.append(company[0].strip())
    elif industry == "education":
        education.append(company[0].strip())
    elif industry == "healthcare":
        healthcare.append(company[0].strip())
    elif industry == "software":
        software.append(company[0].strip())
    else:
        other_industry.append(company[0].strip())
...
for company in other_companies:
    ...
    location = company[1].lower().strip()
...
# TODO 7.3, 7.4
while i < len(salary_list):
    if int(salary_list[i][-1]) >= 100000 and int(salary_list[i][-1]) <= 150000:
        company_salary_one.append(salary_list[i][0])
    elif int(salary_list[i][-1]) > 175000:
        company_salary_two = (salary_list[i][0], int(salary_list[i][-1]))
        break
    i += 1
