...
def main():
    ...
    for i in range(len(players)):
        players[i] = convert_player_numbers(players[i])
    ...
    headers.append("shot_conv_rate")

    # 14.0 Write data to new CSV file
    filepath = parent_path.joinpath("./data-goal_scorers_key.csv")
