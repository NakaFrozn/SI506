...
for i in range(len(new_tv_shows)):
    if "netflix" == new_tv_shows[i][-1].lower():
...
# TODO 2.2
for show in tv_shows:
    cleaned_tv_shows.append(show.split(" | "))
...
# TODO 4.2
for show in cleaned_tv_shows:
    total_rotten_tomato_ratings += show[4]
...
# TODO 8.2
for i in range(len(cleaned_tv_shows)):
    genre = cleaned_tv_shows[i][1].rstrip().lower()
